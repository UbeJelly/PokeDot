...
- `get_version(name_or_id)` - get the versions of the games, e.g., Red, Blue or Yellow.
- `get_version_group(name_or_id)` - get the version groups which categorize highly similar versions of the games.
